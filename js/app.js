(() => {
            ...
            on: {
                slideChange: function(swiper) {
                    ...
                    if (index % 2 == 0) {
                        ...
                        sessionStorage.setItem("current-price-bonus", 3e3);
                    }
                }
            }
        });
    ...
    document.addEventListener("click", (e => {
        ...
        let price = +sessionStorage.getItem("current-price-bonus");
        ...
        if (targetElement.closest(".block-bet__minus_bet")) if (current_bet > 100) {
        ...
        if (targetElement.closest(".block-bet__plus_bet")) if (current_bank - 99 > current_bet) {
            sessionStorage.setItem("current-bet", current_bet + 100);
            document.querySelector(".block-bet__coins_bet").textContent = sessionStorage.getItem("current-bet");
        } else no_money(".check");
        if (targetElement.closest(".block-bet__min")) if (+sessionStorage.getItem("money") >= 100) {
            sessionStorage.setItem("current-bet", 100);
            document.querySelector(".block-bet__coins").textContent = sessionStorage.getItem("current-bet");
        } else no_money(".check");
        if (targetElement.closest(".block-bet__max")) if (+sessionStorage.getItem("money") >= 100) {
        ...
        if (targetElement.closest(".shop__button-back")) {
            document.querySelector(".choose").classList.remove("_hide");
            document.querySelector(".shop").classList.add("_hide");
        }
        if (targetElement.closest(".block-bet__minus_shop") && bet > 1) {
        ...
        if (targetElement.closest(".item-shop__button-buy")) if (current_bank >= bet * price) {
            delete_money(bet * price, ".check");
